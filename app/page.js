  ...
  return (
    <div className={projects.Projects} id='projects'>
      ...
      <div className={projects.Collection}>
        ...
        <ProjectCard link='https://ce-wallington.vercel.app' image='/christEmbassyWallington.png' name='CE Wallington' desc='Website for church built with Nextjs' />
  ...
  return (
    <div className={experience.Experience} id='experience'>
      ...
      <div className={experience.Collection}>
        ...
        <ExperienceCard image='https://media.licdn.com/dms/image/C4D0BAQGOMVo5-P5IHg/company-logo_100_100/0/1674468940073?e=1694649600&v=beta&t=pfDAHn7WyK2uIncMz-lxgm9K8MAzD9F2zH33csXkTCM' link='https://www.wedance.vip' start='JULY 2022' end='SEP 2022' role='Front-end Developer' type='Internship' company='WeDance' desc='Used Vue.js to fix bugs given by various tickets on the github codebase. Helped in designing and building the new WeDance version.' tech={['Vue.js', 'CSS', 'TypeScript']}/>
