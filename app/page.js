  ...
  return (
    <div className={projects.Projects} id='projects'>
      ...
      <div className={projects.Collection}>
        ...
        <ProjectCard link='https://nooodle.vercel.app/app' image='/noodle.png' name='Noodle' desc='Clone of a study space website' />
  ...
  return (	
    <div className={experience.Experience} id='experience'>
      ...
      <div className={experience.Collection}>
        ...
        <ExperienceCard image='https://media.licdn.com/dms/image/C4E0BAQHm5bYK6emQSg/company-logo_200_200/0/1630621204188/goldman_sachs_logo?e=1712793600&v=beta&t=CDVe8qma1cSsdVZ26fOnlT46nVBN4RwSNegSBdDMpbU' link='https://insidesherpa.s3.amazonaws.com/completion-certificates/Goldman%20Sachs/NPdeQ43o8P9HJmJzg_Goldman%20Sachs_u2pPtAhxvS8oQHQfT_1629113234515_completion_certificate.pdf' start='AUG 2021' end='AUG 2021' role='Software Engineer' type='Virtual Experience' company='Goldman Sachs' desc='Cracked leaked password database that had different hashing types like SHA-256, MD5 etc. Using services like hashcat to run the passwords through different hashing algorithms and crack them using methods such as brute force.' tech={['Hashcat', 'Cryptography']}/>
