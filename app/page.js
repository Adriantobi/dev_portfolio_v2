...
function About() {
  return (
    <div className={about.About} id='about-me'>
      <SectionTitle desc='Here is a litle bit about me' title='About' />
...
function Experience() {
  return (
    <div className={experience.Experience} id='experience'>
      <SectionTitle desc='I’m an aspiring software engineer specializing in building and designing astonishing digital experiences for users. Currently, I’m focused on building some projects of my own.' title='Experience' />
