    ...
    <div className={styles.Footer}>
      ...
      <div className={styles.footerContent}>
          ...
          <div className={styles.linkLists}>
              <div className={styles.colElement}>
                  <ul>
                      ...
                      <li><FooterLink link='/pdf/Adrian_Tobi_Resume_05-06-2023-11-13-52.pdf' name='Resume' /></li>
                  </ul>
              </div>
          </div>
        </div>
        ...
        <div className={styles.footerBottom}>
            <footer>The result of a four day bender. Barely designed in Figma and written in Visual Studio Code, I love that editor. Built with Next.js and CSS Modules, deployed with Vercel.</footer>
